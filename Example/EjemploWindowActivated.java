...
public class EjemploWindowActivated {//Modificar el nombre de la clase a su preferencia o realizar una nueva clase con el nombre presente
    ...
    public static void main(String[] args) {
      ...
      //Agregando etiqueta para descripción 
        JLabel label=new JLabel("<html>Al seleccionar esta ventana <br>se ejecutara el metodo </html>");
