...
public class setDefaultCloseOperation {//Modificar el nombre de la clase a su preferencia o realizar una nueva clase con el nombre presente
	 public static void main(String[] args) {
	        // Crear un nuevo JFrame y agregar el título al mismo tiempo, sin utilizar setTitle
	        JFrame frame = new JFrame("Comportamiento para cerrar ventana");
